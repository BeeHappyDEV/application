drop function if exists frontend_text_us_link;

create or replace function frontend_text_us_link (
...
begin
    ...
    select
        'https://api.whatsapp.com/send?phone=' || cst.txt_value
    into
        var_txt_redirect
    from
        dat_constants cst
    where
        cst.txt_key = 'company_text';
