...
| return        | json                                            |
| path          | src\database\frontend\functions\page_action.sql |
...
```sql
drop function if exists frontend.page_action;

create or replace function frontend.page_action (
...
begin
    ...
    if (var_txt_action = 'landing') then
        ...
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_address', var_txt_address);
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_mail', var_txt_mail);
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_phone', var_txt_phone);
    ...
    if (var_txt_action = 'privacy_policy') then
        ...
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_modification', var_txt_modification);
    ...
    if (var_txt_action = 'collaborator') then
        ...
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_full_name', var_txt_full_name);
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_icon', var_txt_icon);
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_mail', var_txt_mail);
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_name', var_txt_name);
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_phone', var_txt_phone);
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_profile', var_txt_profile);
    ...
    if (var_txt_action = 'qr') then
        ...
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_collaborator', 'colaborador/' || var_txt_name);
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_full_name', var_txt_full_name);
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_icon', var_txt_icon);
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_mail', var_txt_mail);
        var_jsn_outgoing = framework.set_text (var_jsn_outgoing, 'txt_name', var_txt_name);
