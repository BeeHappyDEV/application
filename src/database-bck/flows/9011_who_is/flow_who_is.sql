 ...
 *        | :-----: | :---: |
 *        | Intentions | 9011 |
 *        | Expressions | 9011 / 9012 / 9013 / 9014 / 9015 / 9016 |
 *        | Expressions | ![#efba0b](https://placehold.co/20/efba0b/efba0b) |
 *        ```
 *        sequenceDiagram
 *        autonumber
 *        Actor Chatbot
 *        participant F as flow_who_is
 *        Chatbot ->> F: in_jsn_transfer
 *        F ->> F: utils_get_first_name
 *        F ->> F: select dat_users: company_support
